...
-- This is a window, not really floating, just keeping the same name so it would be easy to swap
...
-- Key mappings
vim.keymap.set("n", "<leader>tw", FloatingTerminal, { noremap = true, silent = true, desc = "Toggle floating terminal" })
